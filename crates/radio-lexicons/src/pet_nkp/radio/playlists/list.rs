...
//
// Lexicon: pet.nkp.radio.playlists.list
//
...
pub struct List;
/// Response type for pet.nkp.radio.playlists.list
pub struct ListResponse;
impl jacquard_common::xrpc::XrpcResp for ListResponse {
    const NSID: &'static str = "pet.nkp.radio.playlists.list";
...
/// Endpoint type for pet.nkp.radio.playlists.list
pub struct ListRequest;
impl jacquard_common::xrpc::XrpcEndpoint for ListRequest {
    const PATH: &'static str = "/xrpc/pet.nkp.radio.playlists.list";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
