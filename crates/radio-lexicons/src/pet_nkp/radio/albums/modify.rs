...
//
// Lexicon: pet.nkp.radio.albums.modify
//
...
pub struct Modify<'a> {
    ...
    ///Rotation weight for setWeight: 1 light, 2 normal, 4 heavy.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl jacquard_common::IntoStatic for ModifyAction<'_> {
    ...
    fn into_static(self) -> Self::Output {
        match self {
            ...
            ModifyAction::SetWeight => ModifyAction::SetWeight,
...
/// Response type for pet.nkp.radio.albums.modify
...
/// Endpoint type for pet.nkp.radio.albums.modify
