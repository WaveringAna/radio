...
//
// Lexicon: pet.nkp.radio.albums.list
//
...
pub struct List;
/// Response type for pet.nkp.radio.albums.list
pub struct ListResponse;
impl jacquard_common::xrpc::XrpcResp for ListResponse {
    const NSID: &'static str = "pet.nkp.radio.albums.list";
...
/// Endpoint type for pet.nkp.radio.albums.list
pub struct ListRequest;
impl jacquard_common::xrpc::XrpcEndpoint for ListRequest {
    const PATH: &'static str = "/xrpc/pet.nkp.radio.albums.list";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
